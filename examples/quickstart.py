"""Runs immediately, no setup. Calibrates the shipped ring target and shows
the guard firing on a degenerate view and staying quiet on a healthy one.
...
# so a fresh clone runs this with no install step
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

import numpy as np  # noqa: E402

from blindspot import (FeatureGuard, intrinsics_from_fov,  # noqa: E402
                       pixels_to_normalised)
from blindspot.calibrate import calibrate  # noqa: E402
