...
No ROS imports and no OpenCV, so tests.py can check the exact law the arms
run in Gazebo rather than a transcription of it. Moved verbatim out of
duel_node.py; the marker detector lives in detect.py.
"""
