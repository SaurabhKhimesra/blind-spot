...
Measured first in numpy with this exact control law (see README): at every
...
the fold for that reason, and the clip claims only what the act shows.
...
from blindspot_arm.duel_node import XACRO
from blindspot_arm.law import (DT, K_DEFAULT, R_TARGET, Z_DESIRED,
                               best_cyclic_match, ibvs_twist,
                               order_by_angle)
